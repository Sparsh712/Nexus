...
export function CardPattern({
    ...
    let maskImage = useMotionTemplate`radial-gradient(${maskSize}px at ${mouseX}px ${mouseY}px, white, transparent)`;
    ...
    return (
        (<div className="pointer-events-none">
            ...
            <motion.div
                ...
                style={style} />
            <motion.div
                className="absolute inset-0 rounded-2xl opacity-0 group-hover/card:opacity-100 z-10"
                style={style}>
                <p
